...
class StoneArmorItem(
    ...
    override fun appendTooltip(
        ...
        tooltip.add(Text.translatable("tooltip.advancedcombat.ecological_i").formatted(Formatting.GREEN))
    ...
    override fun inventoryTick(stack: ItemStack, world: World, entity: Entity, slot: Int, selected: Boolean) {
        ...
        if (!world.isClient && entity is PlayerEntity) {
            ...
            if (stack.damage > 0) {
                val interval = if (entity.isWet) 100 else 1200
