...
---
This is a remake of Advanced Combat!

**Original Author**: [SBlectric](https://www.curseforge.com/members/sblectric)

*This mod is not to be confused with Advanced Combat (Revitalized).*
...
### Advanced Shield
- Has higher durability than the vanilla shield.
...
- Wither effect duration = number of equipped pieces × 1 second.
- When 1–2 pieces are equipped, the Wither effect is at level I.
- When 3–4 pieces are equipped, the Wither effect is at level II.
...
### Tracking Dispenser (Still in development)
- Shoots projectiles at the nearest living entity within a 32-block range, rather than only firing in a fixed direction.
...
---
## Credits
- Thanks to [cjiangqiu](https://modrinth.com/user/cjiangqiu) for providing part of the code for the [Creative Sword].
- Thanks to Kc_starry for providing the item textures for the Stone and Obsidian armors.
...
**原作者：** [SBlectric](https://www.curseforge.com/members/sblectric)
...
- 使攻击来源的生物获得凋零效果
- 凋零效果持续时间=装备件数 × 1 秒
- 装备件数为 1 ~ 2 时，凋零效果等级为 1 级
- 装备件数为 3 ~ 4 时，凋零效果等级为 2 级
...
### 追踪发射器 (还在开发阶段)
- 会向 32 格范围内最近的生物实体射击，而非仅朝单一方向发射
...
---
## 鸣谢
- 感谢[C江秋](https://modrinth.com/user/cjiangqiu)提供了［创造之剑］的部分代码
- 感谢Kc_starry提供了石制、黑曜石盔甲的物品贴图